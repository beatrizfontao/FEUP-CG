...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objectIDs = { 'Plane': 0, 'Pyramid': 1, 'Cone': 2, 'Trangram': 3, 'UnitCube': 4, 'Prism': 5, 'Cylinder': 6};
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.5, 0, 0, 1.0);
        this.material4.setDiffuse(0.420, 0.229, 0.0378, 1.0);
